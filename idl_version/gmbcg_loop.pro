...
pro gmbcg_loop,input_dir,cat_dir


   ; input_dir='/data/des_survey_strategy/survey0_1year/'
   ; cat_dir='/data/des_survey_strategy/survey0_1year/gmbcg/'
    version = 1.0
    file=findfile(input_dir+'*.fit')  
    for patch=0,4 do begin
        print,patch
        
        gal=mrdfits(file[patch],1)
        ;gal=gal[where(gal.photoz_gaussian ge  0.1 and gal.photoz_gaussian le 1.0 and gal.omag[0] ne 99 and gal.omag[1] ne 99 and gal.omag[2] ne 99 and gal.omag[3] ne 99 and gal.omag[4] ne 99)]
